...
const EMOTION_CONFIG = {
  ...
  '우울':     { bg: '#eef3ff', color: '#5A8FC8', icon: '😔' },
  '분노':     { bg: '#fff0f0', color: '#FF7675', icon: '😤' },
  '화남':     { bg: '#fff0f0', color: '#FF7675', icon: '😤' },
  '불안':     { bg: '#f3f0ff', color: '#A29BFE', icon: '😟' },
  '두려움':   { bg: '#f3f0ff', color: '#A29BFE', icon: '😨' },
  '피곤':     { bg: '#f5f0e8', color: '#C0A878', icon: '😴' },
  '피로':     { bg: '#f5f0e8', color: '#C0A878', icon: '😴' },
  '피곤함':   { bg: '#f5f0e8', color: '#C0A878', icon: '😴' },
  '뿌듯':     { bg: '#fffce8', color: '#F5C050', icon: '😤' },
  '뿌듯함':   { bg: '#fffce8', color: '#F5C050', icon: '😤' },
  '감사':     { bg: '#f0fff8', color: '#80D8B0', icon: '🙏' },
  '그리움':   { bg: '#eef0ff', color: '#9098D8', icon: '🌙' },
  '외로움':   { bg: '#f0f4ff', color: '#8090C8', icon: '😔' },
  '짜증':     { bg: '#fff4ee', color: '#E8A880', icon: '😠' },
  '후회':     { bg: '#f4f0ff', color: '#B098D8', icon: '😞' },
  '부끄러움': { bg: '#fff0f8', color: '#E8A0C8', icon: '😊' },
  '무기력':   { bg: '#f4f4f4', color: '#B0B0B8', icon: '😶' },
  '멍함':     { bg: '#f0f0f8', color: '#A8A8C0', icon: '😶' },
};
...
const MASCOT_SPEECH = {
  ...
  '화남':     '많이 화가 나셨군요. 그 마음 충분히 이해해요 💪',
  '불안':     '걱정이 많으셨군요. 함께 살펴봐요 🤍',
  '두려움':   '괜찮아요. 제가 함께할게요 🤍',
  '피곤':     '오늘 많이 지치셨군요. 푹 쉬어요 😴',
  '피로':     '오늘 많이 지치셨군요. 푹 쉬어요 😴',
  '피곤함':   '오늘 많이 지치셨군요. 푹 쉬어요 😴',
  '뿌듯':     '오늘 정말 잘 하셨어요! 자랑스러워요 ⭐',
  '뿌듯함':   '오늘 정말 잘 하셨어요! 자랑스러워요 ⭐',
  '감사':     '감사한 마음이 가득한 하루였군요 🙏',
  '그리움':   '그리운 마음이 있군요. 소중한 감정이에요 🌙',
  '외로움':   '외로운 마음이 느껴져요. 제가 여기 있을게요 🤍',
  '짜증':     '짜증스러운 일이 있었군요. 충분히 그럴 수 있어요 😮‍💨',
  '후회':     '후회되는 일이 있으셨군요. 내일은 더 잘 할 수 있어요 🌱',
  '부끄러움': '부끄러운 마음도 솔직하게 써줘서 고마워요 😊',
  '무기력':   '오늘은 쉬어가도 괜찮아요. 내일이 있으니까요 💤',
  '멍함':     '아무 생각 없이 쉬는 것도 필요해요 🌫️',
};
